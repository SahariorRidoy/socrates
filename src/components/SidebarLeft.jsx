            ...
            <div className='flex flex-col justify-between gap-[456px]'>
                ...
                <div>
                    <header className='flex justify-between items-center py-[6px] mb-8'>
                        ...
                        <div className='flex gap-[12px]'>
                            <img src={searchIcon} className='w-6 h-6 cursor-pointer hover:opacity-70 transition-all duration-300' alt="A Search Icon" />
                            <img src={sidebarIcon} className='w-6 h-6 cursor-pointer hover:opacity-70 transition-all duration-300' alt="Sidebar Icon" />
                        </div>
                    </header>
                    <div className="flex border mb-3 border-[#ffffff26] justify-center items-center px-6 py-[10.5px] rounded-[56px] cursor-pointer hover:bg-[#ffffff40] transition-all duration-300">
                        <div className="flex items-center gap-1">
                            <img src={plusIcon} alt="Plus Icon" />
                            <p className="text-sm font-semibold">Add Folder</p>
                        </div>
                    </div>
                    <div className="flex bg-[#ffffff26] justify-center items-center px-6 py-[10.5px] rounded-[56px] cursor-pointer hover:bg-[#ffffff40] transition-all duration-300">
                        <div className="flex items-center gap-1">
                            <img src={plusIcon} alt="Plus Icon" />
                ...
                <div>
                    <div className='bg-[#363636] p-4 rounded-[12px]'>
                        ...
                        <div className="flex border mt-3 border-[#F37F0C] justify-center items-center px-6 py-[10.5px] rounded-[56px] cursor-pointer hover:bg-[#F37F0C] hover:text-white transition-all duration-300">
                            <div>
                                <p className="text-sm font-semibold">Create chat</p>
                            </div>
                        </div>
                    ...
                    <div className='mt-3'>
                        <div className='flex items-center justify-between '>
                            <div className='flex cursor-pointer gap-2 items-center justify-between'>
                                <img src={profileIcon} className='w-9 h-9 ' alt="User Avatar Icon" />
                                <p className='text-sm font-medium '>Jessica Mills</p>
                            </div>
                            <div className='cursor-pointer hover:opacity-80 transition-all duration-300'>
